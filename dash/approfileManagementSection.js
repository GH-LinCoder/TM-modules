...
<div class="grid md:grid-cols-3 lg:grid-cols-4 gap-6" id="stats-cards">
  ...
  <!-- approfiles -->
      ...
      <!-- Return -->
  <div class="bg-gray-200 border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-300 flex flex-col justify-center items-center text-center"  data-action="approfile-management-section">
    <h3 class="text-sm font-bold text-gray-700"">◀️ CLOSE APPROFILE MANAGEMENT</h3>    
  ...
  <div class="bg-blue-50 border border-blue-200 rounded-lg p-4" data-action="delete-approfile-dialogue">
    ...
    <p class="text-xs text-blue-600">Deletion marks the record as deleted, but does not erase it from the system</p>
      ...
      <!-- relate -->
  <div class="bg-red-50 border border-red-100 rounded-lg p-4" data-action="relate-approfiles-dialogue">
  ...
  <!-- DELETE RELATED APPROFILES -->
    <div class="bg-red-50 border border-red-200 rounded-lg p-4 cursor-pointer hover:shadow-md" data-action="delete-related-approfiles-dialogue">
      <h3 class="text-sm font-medium text-blue-700">Delete a relation between two appros 🗑️🖇️</h3>
      <p class="text-xs text-gray-500">Break a relation between things without deleting the things. </p>
    </div>
