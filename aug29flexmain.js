...
import { loadPage } from "./ui/reactToPageButtons.js";
...
// We'll definedisplayArea here, but get it when needed
...
async function onAppLoad() {
  ...
  displayArea = document.querySelector('[data-panel="inject-here"]');

  
  // Initialize with default dashboard
  if (dynamicPanels.length === 0) {
    dynamicPanels[0] = 'adminDash'; // or 'memberDash'
    console.log('Initial dynamicPanels:', dynamicPanels);
  }

  // Load the default dashboard
  await loadPage(dynamicPanels,0,displayArea);
