...
class SurveyDisplay {  // This code doesn't know the format of the data that is returned from the function. Also what is this code trying to do?
    async render(panel, query = {}) {
        ...
        try {
            ...
            const assignedSurveys = await executeIfPermitted(   // the function returns an object data: taskData & data:surveyData
                studentId, 
                'readStudentAssignments', 
                { student_id: studentId }
            );
            console.log('assignedSurveys:',assignedSurveys);  //This doesn't seem to inlcude surveys 20:14 Oct 21
