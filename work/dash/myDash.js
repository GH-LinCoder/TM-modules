 ...
 Click a card once to open the module. <i>Click the card again to close the module</i></div>
                ...
                <div class="bg-gray-100 rounded-lg shadow p-0 md:p-6" data-section='settings' data-destination='settings'>
                  ...
                  <div class="grid md:grid-cols-2 lg:grid-cols-4 p-2 md:p-4">
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-2 md:p-4" data-action="recruitment-management-section">
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-2 md:p-4" onclick="showToast('Rewards not yet implemented')">
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-2 md:p-4" onclick="showToast('Support not yet implemented')">
