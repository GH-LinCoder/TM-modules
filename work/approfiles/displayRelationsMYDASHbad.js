    ...
    <div  class="edit-task-dialogue relative z-10 flex flex-col h-full" data-destination="new-panel">
      <div class="bg-white rounded-lg shadow-lg w-full max-w-4xl mx-4 z-10 max-h-[90vh] overflow-y-auto">
        <div class="p-6 border-b border-gray-200 flex justify-between items-center">
          ...
          <div class="mb-6 bg-blue-50 p-4 rounded-lg border border-blue-200" data-action="selector-dialogue" data-section="instructions">
      ...
      <div class="space-y-4">
        <div  data-section="dropdown-container">
...
function init(panel, query) {
  ...
  if (moduleContext === 'myDash') {
    const instructions = panel.querySelector('[data-section="instructions"]');
    const dropdown = panel.querySelector('[data-section="dropdown-container"]');
